        ...
        <div className="table-container" role="table" aria-label="Destinations">
            <div className="flex-table row " role="rowgroup">
                <div className="flex-row first vertLn horzLn"  role="cell">
                    <img className="imgLight" src="./LightsImg/ABS-light.png" alt="lightImg"/>
                </div>
                ...
                <div className="flex-row first2 vertLn2 horzLn"  role="cell">
                    <img className="imgLight" src="./LightsImg/airbag-indicator.png" alt="lightImg"/>
                </div>
            ...
            <div className="flex-table row" role="rowgroup">
                <div className="flex-row first vertLn horzLn"  role="cell">
                    <img className="imgLight" src="./LightsImg/battery-alert.png" alt="lightImg"/>
                </div>
                ...
                <div className="flex-row first2 vertLn2 horzLn"  role="cell">
                    <img className="imgLight" src="./LightsImg/brake-warning.png" alt="lightImg"/>
                </div>
            ...
            <div className="flex-table row" role="rowgroup">
                <div className="flex-row first vertLn horzLn"  role="cell">
                    <img className="imgLight" src="./LightsImg/check-engine.png" alt="lightImg"/>
                </div>
                ...
                <div className="flex-row first2 vertLn2 horzLn"  role="cell">
                    <img className="imgLight" src="./LightsImg/engine-temperature.png" alt="lightImg"/>
                </div>
            ...
            <div className="flex-table row" role="rowgroup">
                <div className="flex-row first vertLn horzLn"  role="cell">
                    <img className="imgLight" src="./LightsImg/fog-lamp.png" alt="lightImg"/>
                </div>
                ...
                <div className="flex-row first2 vertLn2 horzLn"  role="cell">
                    <img className="imgLight" src="./LightsImg/lane-departure.png" alt="lightImg"/>
                </div>
            ...
            <div className="flex-table row" role="rowgroup">
                <div className="flex-row first vertLn horzLn"  role="cell">
                    <img className="imgLight" src="./LightsImg/low-fuel.png" alt="lightImg"/>
                </div>
                ...
                <div className="flex-row first2 vertLn2 horzLn"  role="cell">
                    <img className="imgLight" src="./LightsImg/oil-pressure.png" alt="lightImg"/>
                </div>
            ...
            <div className="flex-table row" role="rowgroup">
                <div className="flex-row first vertLn horzLn"  role="cell">
                    <img className="imgLight" src="./LightsImg/seat-belt.png" alt="lightImg"/>
                </div>
                ...
                <div className="flex-row first2 vertLn2 horzLn"  role="cell">
                    <img className="imgLight" src="/./LightsImg/security-indicator.png" alt="lightImg"/>
                </div>
            ...
            <div className="flex-table row" role="rowgroup">
                <div className="flex-row first vertLn horzLn"  role="cell">
                    <img className="imgLight" src="./LightsImg/shift-lock.png" alt="lightImg"/>
                </div>
                ...
                <div className="flex-row first2 vertLn2 horzLn"  role="cell">
                    <img className="imgLight" src="./LightsImg/tire-pressure.png" alt="lightImg"/>
                </div>
            ...
            <div className="flex-table row" role="rowgroup">
                <div className="flex-row first vertLn horzLn"  role="cell">
                    <img className="imgLight" src="./LightsImg/traction-control-malfunction.png" alt="lightImg"/>
                </div>
                ...
                <div className="flex-row first2 vertLn2 horzLn"  role="cell">
                    <img className="imgLight" src="./LightsImg/traction-control.png" alt="lightImg"/>
                </div>
            ...
            <div className="flex-table row" role="rowgroup">
                <div className="flex-row first vertLn"  role="cell">
                    <img className="imgLight" src="./LightsImg/transmission-temperature.png" alt="lightImg"/>
                </div>
                ...
                <div className="flex-row first2 vertLn2"  role="cell">
                    <img className="imgLight" src="./LightsImg/washer-fluid.png" alt="lightImg"/>
                </div>
